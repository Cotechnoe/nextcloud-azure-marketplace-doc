...
| **Portée** | Tous les contenus publiés dans `nextcloud-azure-marketplace-doc` et `nextcloud-azure-marketplace-doc.wiki` |
...
- n'ont pas accès au dépôt `Cotechnoe/nextcloud-marketplace` ;
...
|-------|------|-------------|
| `Cotechnoe/nextcloud-azure-marketplace-doc` | README et page d'accueil documentation | `github.com/Cotechnoe/nextcloud-azure-marketplace-doc` |
| `Cotechnoe/nextcloud-azure-marketplace-doc.wiki` | Pages de documentation détaillées | `github.com/Cotechnoe/nextcloud-azure-marketplace-doc/wiki` |

**Problème principal :** Sans une politique de contenu explicite, il y a un risque de glissement vers une documentation orientée *développement* (ADRs internes, Makefile, Packer, GitHub Actions) inadaptée aux clients Marketplace et possiblement non conforme aux directives Microsoft.
...
Ne pas référencer :
- `github.com/Cotechnoe/nextcloud-marketplace`
...
- Issues GitHub sur `Cotechnoe/nextcloud-azure-marketplace-doc` (support utilisateur)
...
|-------|------------------|-------|
| **Badge "Available on Microsoft Marketplace"** | `README.md` du dépôt `Cotechnoe/nextcloud-azure-marketplace-doc` | Obligatoire — utiliser le badge officiel, pas un badge custom |
...
### `Cotechnoe/nextcloud-azure-marketplace-doc`
...
### `Cotechnoe/nextcloud-azure-marketplace-doc.wiki`
...
- [ ] Aucune référence au dépôt développeur (`Cotechnoe/nextcloud-marketplace`)
...
| Mentionner des ADRs internes du build repo | Jargon interne | Remplacer par la description de l'effet observable |
